...
# Unit tests for GoodSender::ErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GoodSender::ErrorResponse do
  #let(:instance) { GoodSender::ErrorResponse.new }

  describe 'test an instance of ErrorResponse' do
    it 'should create an instance of ErrorResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GoodSender::ErrorResponse)
    end
  end
