...
# Unit tests for GoodSender::SendEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe GoodSender::SendEmail do
  #let(:instance) { GoodSender::SendEmail.new }

  describe 'test an instance of SendEmail' do
    it 'should create an instance of SendEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(GoodSender::SendEmail)
    end
  end
  ...
  describe 'test attribute "markdown_content"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
